...
<html id="html" lang="en" style="display: none"> <!--Display none för att undvika FOUC, byter till display block direkt i JS filen, verkar vara Firefox som har det problemet -->
    ...
    <body class="flex justify-center h-screen text-darkblue bg-white box-border px-8 font-poppins tablet:px-16">
        ...
        <svg viewBox="120 0 100 200" class="hidden w-[200px] left-0 top-[600px] absolute tablet:block laptop:w-[225px] laptop:top-[300px] desktop:w-[275px] desktop:top-[300px]">
            <path id="left-blob" d="" fill="#7678ED" class="duration-400"></path>
        </svg>
        ...
        <svg viewBox="-20 0 100 200" class="hidden w-[225px] right-0 top-[500px] absolute tablet:block laptop:w-[250px] laptop:top-[150px] desktop:w-[325px] desktop:top-[175px]">
            <path id="right-blob" d="" fill="#7678ED" class="duration-400"></path>
        </svg>
        ...
        <div id="front-page" class="hidden w-full h-full">
            <div class="flex flex-col justify-between items-center py-52 h-full tablet:py-72 laptop:pt-56 laptop:pb-36">
                <div id="front-page-text" class="flex flex-col gap-4 items-center duration-400 scale-0">
                ...
                <div id="front-page-button-container" class="flex justify-center w-full duration-400 scale-0">
        ...
        <div id="question-page" class="hidden w-full h-full">
            <div class="flex flex-col justify-between items-center py-52 h-full tablet:py-72 laptop:pt-56 laptop:pb-36">
                <div id="question-page-text" class="flex flex-col gap-4 items-center duration-400 scale-0">
                ...
                <div id="question-page-button-container" class="flex justify-center w-full duration-400 scale-0">
        ...
        <div id="answer-page" class="hidden w-full h-full text-white">
            <div class="flex flex-col justify-between items-center py-52 h-full tablet:py-72 laptop:pt-56 laptop:pb-36">
                <div id="answer-page-text" class="flex flex-col gap-4 w-full items-center duration-400 scale-0">
                ...
                <div id="answer-page-button-container" class="flex w-full flex-col gap-4 items-center duration-400 scale-0 laptop:gap-8">
        ...
        <div id="result-page" class="hidden bg-white text-darkblue">
            <div class="flex flex-col pt-40 items-center gap-4 tablet:pt-64 laptop:pt-42">
                <div id="result-page-text" class="flex flex-col items-center duration-400 scale-0">
                ...
                <div id="result-page-blobs" class="flex flex-row w-72 justify-center gap-2 flex-wrap duration-400 scale-0 tablet:w-96 tablet:mb-4 laptop:w-fit"> 
                ...
                <div id="result-page-button-container" class="flex justify-center w-full duration-400 scale-0">
